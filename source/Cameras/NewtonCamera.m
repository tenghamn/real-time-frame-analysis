classdef NewtonCamera<handle
    ...
    methods
        ...
        function width = get.imageMaxWidth(obj)
            width = floor(1024/obj.horisontalBinning);
        end
        
        function height = get.imageMaxHeight(obj)
            height = floor(256/obj.verticalBinning);
        end
        ...
        function setAreaOfInterest(obj,verticalBinning,horisontalBinning,width,height,leftPosition,topPosition)
            ...
            CheckWarning(ret);
            if ret == atmcd.DRV_SUCCESS
                obj.imageMaxWidth = round(obj.imageMaxWidth/verticalBinning);
                obj.imageMaxHeight = round(obj.imageMaxHeight/horisontalBinning);
    ...
    methods(Access=private)
        ...
        function setInitialCameraSettings(obj)
            ...
            obj.verticalBinning = 1;
            obj.horisontalBinning = 1;
            obj.setAreaOfInterest(1,1,1024,256,1,1);
            disp('Settings Done');
        end
